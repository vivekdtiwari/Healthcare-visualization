    ...
    console.log(this.state.BarChart.data);
		return (
			<div className="Examples">
				<h3> Bar Chart </h3>
				<Chart chartType={this.state.BarChart.chartType} width={"100%"} height={"500px"} data={googleRender} options = {this.state.BarChart.options} graph_id={this.state.BarChart.div_id} />
			</div>
		);
	}
